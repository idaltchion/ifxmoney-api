package com.idaltchion.ifxmoney.api.storage;
...
public class S3 {
	...
	public String salvarTemporariamente(MultipartFile arquivo) {
		...
		try {
			...
			throw new RuntimeException("Problema ao tentar enviar aquivo para o S3.", e);
		}
	...
	public void salvar(String objeto) {
		//limpa/remove a tag da regra de expiracao do objeto/anexo
