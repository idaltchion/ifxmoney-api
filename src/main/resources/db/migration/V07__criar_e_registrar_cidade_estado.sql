...
INSERT INTO cidade (codigo, nome, codigo_estado) VALUES (10, 'Curitiba', 18);
INSERT INTO cidade (codigo, nome, codigo_estado) VALUES (11, 'São José dos Pinhais', 18);

ALTER TABLE pessoas DROP COLUMN cidade;
ALTER TABLE pessoas DROP COLUMN estado;
ALTER TABLE pessoas ADD COLUMN codigo_cidade BIGINT(20);
ALTER TABLE pessoas ADD CONSTRAINT fk_pessoas_cidade FOREIGN KEY (codigo_cidade) REFERENCES cidade(codigo);

UPDATE pessoas SET codigo_cidade = 2;
